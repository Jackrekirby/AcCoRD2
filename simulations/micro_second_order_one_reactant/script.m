...
clc;
moleculeStyle = struct('colormap', @hsv, 'colorMethod', 'moleculetype', 'fill', false, 'size', 1000);
...
% Watch Video Live
view([0, 0]);
video = Accord2.videoLive(video, 10, 90);

%% Record Video
video = Accord2.videoRecord(video, 1, "/video.mp4");
