...
%             simulation.activeActors = Accord.importActiveActorShapes(simulationDir, trackImporting);
        ...
        function plotShapes(configFilePath, render)
            ...
            % Mesoscopic Regions
            if(render.Meso && isfield(s, "MesoscopicRegions"))
            ...
            % Microscopic Regions
            if(render.Micro && isfield(s, "MicroscopicRegions"))
...
%         end
%         
%         function subvolume = importSubvolumeShapes(simulationDir, trackImporting)
%             subvolume = jsondecode(fileread(simulationDir + "\subvolumes.json"));
%             if(trackImporting)
%                 disp(simulationDir + "\subvolumes.json");
%             end
%         end
%         
...
%             end
%             shape3D.FaceAlpha = 0;
%             hPlots = shape3D.plot(simulation.subvolumes.shapes);
%         end
%         
